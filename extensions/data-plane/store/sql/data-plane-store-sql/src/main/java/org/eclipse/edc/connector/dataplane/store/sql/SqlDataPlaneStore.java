...
public class SqlDataPlaneStore extends AbstractSqlStore implements DataPlaneStore {
    ...
    public SqlDataPlaneStore(DataSourceRegistry dataSourceRegistry, String dataSourceName, TransactionContext transactionContext, DataPlaneStatements statements, ObjectMapper objectMapper, Clock clock, QueryExecutor queryExecutor) {
    ...
    private State stateById(Connection connection, String processId) {
        ...
        return queryExecutor.executeQuerySingle(connection, false, this::mapToState, sql, processId);
    }
    ...
    private void insert(Connection connection, String processId, State state) {
        ...
        queryExecutor.executeQuery(connection, sql, processId, state.getCode(), createdAt, createdAt);
    }
    ...
    private void update(Connection connection, String processId, State state) {
        ...
        queryExecutor.executeQuery(connection, sql, state.getCode(), updatedAt, processId);
    }
}
