...
public class SqlQueryExecutorConfiguration {
    ...
    public SqlQueryExecutorConfiguration(Integer fetchSize) {
        this.fetchSize = fetchSize;
    }

    public SqlQueryExecutorConfiguration() {
        this.fetchSize = Integer.parseInt(DEFAULT_EDC_SQL_FETCH_SIZE);
    }
