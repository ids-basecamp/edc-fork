...
public interface QueryExecutor {
     ...
     * @return rowsChanged
     */
    int executeQuery(Connection connection, String sql, Object... arguments);
     ...
     */
    <T> Stream<T> executeQuery(Connection connection, boolean closeConnection, ResultSetMapper<T> resultSetMapper, String sql, Object... arguments);
     ...
     * @return the first entity that satisfies the query, null if none exists
     */
    <T> T executeQuerySingle(Connection connection, boolean closeConnection, ResultSetMapper<T> resultSetMapper, String sql, Object... arguments);
}