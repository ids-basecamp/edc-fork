...
public final class SqlQueryExecutor {
    ...
    public static final Integer DEFAULT_EDC_SQL_FETCH_SIZE = 5000;

    public static Integer fetchSize = DEFAULT_EDC_SQL_FETCH_SIZE;

    private SqlQueryExecutor() {
    }

    private SqlQueryExecutor(Integer fetchSize) {
